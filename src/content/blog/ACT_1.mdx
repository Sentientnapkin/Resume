...
<video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
  <source src="/blog_images/ACT_Training_1_1.mp4" type="video/mp4" />
</video>

<video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
  <source src="/blog_images/ACT_Training_1_2.mp4" type="video/mp4" />
</video>
...
<video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
  <source src="/blog_images/ACT_Eval_1_1.mp4" type="video/mp4" />
</video>

<video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
  <source src="/blog_images/ACT_Eval_1_2.mp4" type="video/mp4" />
</video>
...
<div style="display:flex;">
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Training_2_1_1.mp4" type="video/mp4" />
    </video>
  </div>
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Training_2_1_2.mp4" type="video/mp4" />
    </video>
  </div>
</div>
...
<div style="display:flex;">
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Training_2_2_1.mp4" type="video/mp4" />
    </video>
  </div>
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Training_2_2_2.mp4" type="video/mp4" />
    </video>
  </div>
</div>
...
<div style="display:flex;">
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Eval_2_1_1.mp4" type="video/mp4" />
    </video>
  </div>
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Eval_2_1_2.mp4" type="video/mp4" />
    </video>
  </div>
</div>
...
<div style="display:flex;">
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Eval_2_2_1.mp4" type="video/mp4" />
    </video>
  </div>
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Eval_2_2_2.mp4" type="video/mp4" />
    </video>
  </div>
</div>
...
<div style="display:flex;">
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Eval_3_1_1.mp4" type="video/mp4" />
    </video>
  </div>
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Eval_3_1_2.mp4" type="video/mp4" />
    </video>
  </div>
</div>
...
<div style="display:flex;">
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Eval_3_2_1.mp4" type="video/mp4" />
    </video>
  </div>
  <div style="flex:1; padding: 0px 5px;">
    <video controls style={{maxWidth: '375px', maxHeight: '500px', marginTop: '1.5rem', marginBottom: '1.5rem', borderRadius: '0.5rem'}}>
        <source src="/blog_images/ACT_Eval_3_2_2.mp4" type="video/mp4" />
    </video>
  </div>
</div>
